...
namespace AzureServices.Services.Monitor
{
    ...
    {
        public MonitorEmptySuccessResult(List<string> successMessages) : base(MonitorResultCode.NoContent, successMessages, default(T) ?? throw new Exception($"value {typeof(T)} is null"))
        {
        }
    }
    ...
    {
        public MonitorErrorResult(List<string> errorMessages, MonitorResultCode statusCode) : base(statusCode, errorMessages, default(T) ?? throw new Exception($"value {typeof(T)} is null"))
        {
        }
    }
